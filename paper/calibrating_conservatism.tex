...
mitigates overestimation without an explicit conservative penalty;
integrating these as additional baselines is identified as near-term future
work.
...
\emph{within} a dataset, and this proxy should be read as a calibration
diagnostic rather than a performance score; environment rollouts with
official D4RL normalisation are left to future work.
...
evaluation; (iv)~implicit-Q and advantage-weighted baselines.
